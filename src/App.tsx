...
function App() {
  ...
  const getParentNodes = (nodes: JsonNode[], targetKey: string): string[] => {
    ...
    const findParents = (node: JsonNode, parentPath: string[] = []): boolean => {
      ...
      if (node.children) {
        return node.children.some((child: JsonNode) => 
                ...
                >
                  ...
                  <Box sx={{ 
                    ...
                    '& pre': {
                      ...
                      wordBreak: 'break-word', // 允许在任意字符处换行
                      maxWidth: '100%' // 限制最大宽度
                    }
                  }}>
                    <SyntaxHighlighter
